...
public final class AdminHBD_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<form id=\"testform\" action=\"AdminHBData\" method=\"post\" novalidate>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<p for=\"firstName\" class=\"w3_field1\">Seat</p>\n");
      out.write("\t\t\t\t\t<input id=\"firstName\" name=\"A1\" type=\"text\" required data-error-msg=\"Enter Place\" />\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<p for=\"phoneNum\">Bus Type</p>\n");
      out.write("\t\t\t\t\t<input id=\"phoneNum\" name=\"A2\" type=\"text\" required data-error-msg=\"Enter Place\" />\n");
      out.write("\t\t\t  \n");
      out.write("\t\t\t\t\t<p>Distance</p>\n");
      out.write("                                        <input id=\"emailAddress\" name=\"A3\" type=\"text\"  required data-error-msg=\"Enter Arrival Time \" ></input>\n");
      out.write("\t\t\t  \n");
      out.write("\t\t\t\t\t<p for=\"secondName\">Price</p>\n");
      out.write("\t\t\t\t\t<input id=\"secondName\" name=\"A4\" type=\"text\" required data-error-msg=\"Enter Distance\" />\n");
      out.write("\t\t\t\t        \n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t</fieldset>\n");
      out.write("\n");
